...
class Occluded_REID(ImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        self.train_dir = osp.join(
            self.dataset_dir, 'Occluded_REID/bounding_box_train.txt'
        )
        self.query_dir = osp.join(self.dataset_dir, 'Occluded_REID/query.txt')
        self.gallery_dir = osp.join(
            self.dataset_dir, 'Occluded_REID/bounding_box_test.txt'
        )
